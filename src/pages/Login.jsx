...
const Login = () => {
    ...
    const handleSubmit=async(e)=>{
        ...
        e.preventDefault();
        try {
           const response=await axios.post("https://employee-api-khaki-nine.vercel.app/api/auth/login",{email,password})
    ...
    return (
        <div className="flex flex-col items-center h-screen justify-center bg-gradient-to-b from-teal-600 from-50% to-gray-100 to-50% space-y-6">
            <h2 className="text-3xl text-white" id="chiku">Employee Management System</h2>
            <div className="border shadow p-6 w-80 bg-white">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4 flex items-center justify-between">
                        <label className="inline-felx items-center">
