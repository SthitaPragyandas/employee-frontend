...
const AdminSummary = () => {
    ...
    useEffect(() => {
        const fetchSummary = async () => {
            try {
                const summary = await axios.get(`https://employee-api-khaki-nine.vercel.app/api/dashboard/summary`, {
                    headers: {
    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                ...
                <SummaryCard icon={<FaMoneyBillWave />} text="Monthly Salary Departments" number={summary.totalSalary} color="bg-red-600" />
            </div>
            <div className="mt-12">
