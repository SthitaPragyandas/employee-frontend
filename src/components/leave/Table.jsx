...
function Table() {
    ...
    const fetchLeaves = async () => {
        try {
            const response = await axios.get("https://employee-api-khaki-nine.vercel.app/api/leave", {
                headers: {
            ...
            {filteredLeaves ? (
                <div className='p-6' >
                    ...
                    <div className="flex justify-between items-center">
                        <input type="text" placeholder="Seach By Emp Id" className="px-4 py-0.5 border rounded" onChange={filterByInput} />
